...
void InitReplacementState()
{
    ...
    int sample_sets_num = 30*NUM_CORE;
    if(cfg==1 || cfg == 2){
        int random_number[30]={46, 102, 257, 406, 510, 630, 772, 880, 981, 1088, 1163, 1206, 1311, 1436, 1543, 1644, 1735, 1810, 1956, 2017, 2295, 2410, 2450, 2508, 2553, 2592, 2700, 2976, 3084, 3359, 3557, 3780, 3879, 4303, 4328, 4397, 4428, 4514, 4561, 4852, 4897, 4943, 5000, 5187, 5314, 5361, 5532, 5535, 5635, 5646};
